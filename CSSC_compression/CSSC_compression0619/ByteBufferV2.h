...
#include <string>
#include <cstring>
#ifndef __BYTEBUFFERV2__
#define __BYTEBUFFERV2__
...
public:
	...
	ByteBufferV2(std::vector<std::uint8_t> _bytes); // load the data from _bytes to bytes. use memcpy to enhance speed. [lr]
